...
void BtreeTest::test2()
{
	...
	for (int i = 0; i < num; i++)
	{
		...
		else
		{
			...
			cout << "Problem encountered while inserting key [" << i << "]"
					<< endl;
		}
	}
	...
	for (int j = 0; j < num; j++)
	{
		...
		{
			cout << "Problem encountered while deleting key [" << j << "]"
					<< endl;
		}
	}
...
void BtreeTest::test3()
{
	...
	for (int i = 0; i < num; i++)
	{
		...
		{
			cout << "Problem encountered while inserting key [" << num_mult
					<< "]" << endl;
		}
		...
		{
			cout << "Problem encountered while inserting key [" << num_add
					<< "]" << endl;
		}
	...
	for (int i = 0; i < num; i++)
	{
		...
		{
			cout << "Problem encountered while deleting key [" << num_mult
					<< "]" << endl;
		}
		...
		{
			cout << "Problem encountered while deleting key [" << num_add << "]"
					<< endl;
		}
...
void BtreeTest::test4()
{
	...
	while ((status = new_scan->getNext((int*) &key)) == OK)
	{
		count++;
		cout << "Scanned key [" << *key << "]" << endl;
	}
